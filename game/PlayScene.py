...
from Trengine.Game.Tiles import TileDict
...
class PlayScene(GameScene):
    def __init__(self, game, name) -> None:
        ...
        self.sprite_sheet = SpriteSheet(
            "game/assets/colored-transparent.png", 16, 1)
    ...
    def update(self, dt):
        ...
        if not self.paused:
            ...
            self.ECSWorld.update(self.dt, list_components=[
                                 "SpriteComponent"], whitelist_flag=False)
    ...
    def draw(self):
        ...
        self.ECSWorld.update(self.dt, list_components=[
                             "SpriteComponent"], whitelist_flag=True)
